<footer class="footer-link">
					<p class="tm-copyright-text">Copyright &copy; Skinpedia.
                    
                    - Design: LenteraSoft</p>
				</footer>
			</div>	<!-- row -->			
		</div>
		...
		<script type="text/javascript" src="<?php bloginfo('template_url');?>/slick/slick.min.js"></script> <!-- Slick Carousel -->
